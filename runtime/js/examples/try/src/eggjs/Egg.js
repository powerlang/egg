...
let Egg = class {
	...
	/// public API
	async loadKernelFile(kernelPath = 'Kernel.json')
	{
		const module = await this.loadModuleFromFile(kernelPath, false);
	...
	async loadModuleFromFile(filename, sendJustLoaded = true)
	{
		const reader = new ImageSegmentReader();
		await reader.loadFile('image-segments/' + filename);
...
//			_minSMI: BigInt("-4611686018427387904"),
			_maxSMI: 4611686018427387903,
			_minSMI: 4611686018427387904,
